...
class StockData:
    ...
    def stock_dataframe(self, stockname: str) -> list:
        ...
        for path_ending in [
            ...
            # example
            # data_folder_path: C:\Users\hakan\OneDrive\Documents\Github\Databehandling-Hakan-Akerblom\Code-alongs/stockdata
            # stockname: AAPL
            # path_ending: _TIME_SERIES_DAILY_ADJUSTED.csv
            # resulting path: C:\Users\hakan\OneDrive\Documents\Github\Databehandling-Hakan-Akerblom\Code-alongs/stockdata\AAPL_TIME_SERIES_DAILY_ADJUSTED.csv
